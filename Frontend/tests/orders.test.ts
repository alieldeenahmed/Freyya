...
import { FREE_SHIPPING_THRESHOLD, computeTotals, generateOrderId } from "@/lib/orders";
...
describe("generateOrderId", () => {
  it("looks like FRY- followed by seven characters", () => {
    expect(generateOrderId()).toMatch(/^FRY-[A-Z0-9]{7}$/);
  });
});
